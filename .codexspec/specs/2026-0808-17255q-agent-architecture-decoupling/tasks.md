...
- [ ] **T106 (`D-AUT-004`)** TDD exact UTF-8 backlog description preservation under a 64-MiB whole-file ceiling, multiline and fenced Markdown, Unicode, deterministic empty fallback, full requirements materialization, and item, byte-length, and SHA-256 traceability without authoritative truncation; update `DV-AUT-004` only after Green. Dependencies: T105. Covers: REQ-011, NFR-006, NFR-010.
