...
- [ ] **T109 (`D-AUT-007`)** TDD stable item markers in issue bodies, recorded-number revalidation, complete marker pagination, zero/one/multiple-match behavior, closed-issue reuse, durable binding before PR work, and outbox event identity with idempotent at-least-once reporting; update `DV-AUT-007` only after Green. Dependencies: T108. Covers: REQ-011, NFR-006, NFR-010.
