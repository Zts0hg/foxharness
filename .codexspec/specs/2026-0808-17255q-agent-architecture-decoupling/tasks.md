...
- [x] **T043** Execute proofs for `DV-CHD-001..006`, separating invocation-adapter and runtime-lifecycle behavior and preserving the one-level ceiling; record and stop on defects. Dependencies: T006, T090-T096. Covers: REQ-012, NFR-005, NFR-006, NFR-010; Plan: Child defect gate. **Correction stop active with semantics confirmed in DEC-045:** all six risks are proven defects; T044 and later baseline/refactor tasks remain blocked until T097-T102 each land through an independent Red-Green-Refactor commit and the complete post-correction gate passes.
