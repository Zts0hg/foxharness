...
- [ ] **T108 (`D-AUT-006`)** TDD structured independent one-MiB stdout and stderr capture, typed overflow, strict JSON-query overflow failure, query, gate, and stage-attempt deadlines, registered process-tree supervision, bounded TERM-to-KILL reaping, post-cancel suppression, and SIGINT/SIGTERM exit mapping; update `DV-AUT-006` only after Green. Dependencies: T107. Covers: REQ-011, NFR-006, NFR-010.
